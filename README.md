...
# 0331springboot基于springboot养老院管理系统pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T1bpekEK7?p=4)


# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于养老院管理系统信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立养老院管理系统，来规范养老院管理系统信息管理流程，让管理工作可以系统化和程序化，同时，养老院管理系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
养老院管理系统可以对养老院管理系统信息进行集中管理，可以真正避免传统管理的缺陷。养老院管理系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，养老院管理系统都可以轻松应对。所以，养老院管理系统的运用是让养老院管理系统信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管养老院管理系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作养老院管理系统时可以最大化运用养老院管理系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发养老院管理系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析养老院管理系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:/Users/Administrator/Desktop/temp111\2\img\家属.jpg](/md/blog.005.jpeg)
家属实体属性图

（2）下图是公告信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\公告信息.jpg](/md/blog.006.jpeg)
公告信息实体属性图

（3）下图是老人实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\老人.jpg](/md/blog.007.jpeg)
老人实体属性图

（4）下图是字典表实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\字典表.jpg](/md/blog.008.jpeg)
字典表实体属性图

（5）下图是体检实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\体检.jpg](/md/blog.009.jpeg)
体检实体属性图

（6）下图是食物实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\食物.jpg](/md/blog.010.jpeg)
食物实体属性图

（7）下图是老人外出信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\老人外出信息.jpg](/md/blog.011.jpeg)
老人外出信息实体属性图

（8）下图是家属意见实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\家属意见.jpg](/md/blog.012.jpeg)
家属意见实体属性图

（9）下图是老人家属信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\老人家属信息.jpg](/md/blog.013.jpeg)
老人家属信息实体属性图
...
|4|jiankang\_types|Integer|健康状态|是|
|5|yonghu\_age|Integer|年龄|是|
|6|yonghu\_phone|String|紧急联系方式|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiashu\_name|String|家属名称|是|
|3|jiashu\_photo|String|家属照片|是|
|4|jiashu\_phone|String|联系电话|是|
|5|jiashu\_email|String|邮箱|是|
|6|jiashu\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiashuyijian\_name|String|标题|是|
|3|jiashuyijian\_types|Integer|类型|是|
|4|jiashu\_id|Integer|家属|是|
|5|jiashuyijian\_content|String|详细信息|是|
|6|jiashuyijian\_delete|Integer|逻辑删除|是|
|7|create\_time|Date|创建时间     homeMain|是|
表4.5老人家属信息表

|序号|列名|数据类型|说明|允许空|
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|老人|是|
|3|jiashu\_id|Integer|家属|是|
|4|laorenjiashu\_types|Integer|家属身份|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meishi\_name|String|食物名称|是|
|3|meishi\_photo|String|食物照片|是|
|4|meishi\_types|Integer|食物类型|是|
|5|meishi\_new\_money|BigDecimal|价格|是|
|6|meishi\_content|String|食物介绍|是|
|7|meishi\_delete|Integer|逻辑删除|是|
|8|create\_time|Date|创建时间     homeMain|是|
表4.7公告信息表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|tijian\_name|String|标题|是|
|3|tijian\_types|Integer|体检项目|是|
|4|tijian\_new\_money|BigDecimal|体检价格|是|
|5|tijian\_content|String|体检项目介绍|是|
|6|tijian\_delete|Integer|逻辑删除|是|
|7|create\_time|Date|创建时间     homeMain|是|
表4.9老人外出信息表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|waichu\_name|String|标题|是|
|3|waichu\_types|Integer|外出目的|是|
|4|waichu\_time|Date|外出时间|是|
|5|huilia\_time|Date|回来时间|是|
|6|yonghu\_id|Integer|老人|是|
|7|waichu\_text|String|备注|是|
|8|waichu\_content|String|详情|是|
|9|waichu\_delete|Integer|逻辑删除|是|
